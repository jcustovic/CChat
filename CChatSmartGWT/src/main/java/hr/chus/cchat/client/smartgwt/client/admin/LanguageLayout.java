 ...
 */
public class LanguageLayout extends HLayout {

    private static final String DESCRIPTION = "Language";
    ...
    public static class Factory implements PanelFactory {
        ...
        public Canvas create() {
            LanguageLayout panel = new LanguageLayout();
            panel.setMargin(5);
            panel.setWidth100();
            panel.setHeight100();
    ...
    public Canvas getViewPanel() {
        ...
        label.setHeight(10);
        label.setWidth100();
        label.setContents(DictionaryInstance.dictionary.languages());
        ...
        listGrid.setDataSource(LanguageDS.getInstance());
        ...
        listGrid.addRecordClickHandler(new RecordClickHandler() {
            ...
            public void onRecordClick(RecordClickEvent event) {
                ...
                ds.setAlternateUrl(Constants.CONTEXT_PATH + "admin/language/save");
            }
        });
            ...
            public void onClick(ClickEvent event) {
                ...
                if (form.validate()) {
                    form.submit(new DSCallback() {
                        ...
                        @Override
                        public void execute(DSResponse p_response, Object p_jsonData, DSRequest p_request) {
        ...
        deleteButton.addClickHandler(new ClickHandler() {
            ...
            @Override
            public void onClick(ClickEvent event) {
                ds.setAlternateUrl(Constants.CONTEXT_PATH + "admin/language/delete");
                form.submit();
                deleteButton.setDisabled(true);
                saveButton.setDisabled(true);
                form.setVisible(false);
    ...
    private FormItem[] getFormFields() {
        HiddenItem id = new HiddenItem("language.id");
        TextItem name = new TextItem("language.name", DictionaryInstance.dictionary.name());
        name.setLength(80);
        name.setRequired(true);
        TextItem shortCode = new TextItem("language.shortCode", DictionaryInstance.dictionary.langShortCode());
        shortCode.setRequired(true);
        shortCode.setLength(2);

        return new FormItem[] { id, name, shortCode };
    }

    private ListGridField[] getGridFields() {
        ListGridField name = new ListGridField("language.name", DictionaryInstance.dictionary.name());
        ListGridField description = new ListGridField("language.shortCode", DictionaryInstance.dictionary.langShortCode());
