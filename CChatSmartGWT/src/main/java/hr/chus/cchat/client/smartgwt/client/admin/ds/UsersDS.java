...
public class UsersDS extends DataSource {
    ...
    public UsersDS(final String p_id) {
        ...
        final DataSourceTextField serviceProviderId = new DataSourceTextField("user.serviceProvider", DictionaryInstance.dictionary.serviceProvider(), 15,
                false);
        ...
        final DataSourceTextField msisdn = new DataSourceTextField("user.msisdn", DictionaryInstance.dictionary.msisdn(), 30, true);
        ...
        setFields(pkField, nickName, operatorId, operatorUsername, serviceProviderId, botId, serviceProviderName, msisdn, name, surname, address, birthdate,
                deleted, joined, lastMsg, unreadMsgCount, notes, nickId);
