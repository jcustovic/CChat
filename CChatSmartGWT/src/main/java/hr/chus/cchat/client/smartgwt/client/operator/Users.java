...
public class Users extends HLayout {
    ...
    private FormItem[] getFormFields() {
        ...
        return new FormItem[] { id, name, surname, address, notes, nickItem, operatorItem, botItem, birthdate, deleted, joined, lastMsgDate, unreadMsgCount };
    }
    ...
    private ListGridField[] getGridFields() {
        ...
        return new ListGridField[] { id, name, surname, address, notes, nickName, operator, bot, operatorUsername, nick, joined, birthDate };
    }
